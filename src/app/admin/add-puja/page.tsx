...
export default function AddPujaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert("Failed to add puja: " + data.error);
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Add New Puja</h1>
      <p className="text-gray-500 mb-8">Create a new online puja offering for users to book.</p>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-1">Main Puja Image * (1st in Slider)</label>
            <input
              required
              type="file"
              accept="image/*"
