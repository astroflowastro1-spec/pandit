...
export default function AddChadhavaPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    package2Title: "Special Combo Chadhava",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert("Failed to add Chadhava: " + data.error);
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Add New Chadhava</h1>
      <p className="text-gray-500 mb-8">Create a new online Chadhava offering for users to book.</p>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-1">Main Chadhava Image * (1st in Slider)</label>
            <input
              required
              type="file"
              accept="image/*"
          ...
          <div className="md:col-span-1">
            <label className="block text-sm font-medium text-gray-700 mb-1">Slider Image 2 (Optional)</label>
            <input
              type="file"
              accept="image/*"
          ...
          <div className="md:col-span-1">
            <label className="block text-sm font-medium text-gray-700 mb-1">Slider Image 3 (Optional)</label>
            <input
              type="file"
              accept="image/*"
          ...
          <div className="md:col-span-1 bg-orange-50/50 p-5 rounded-xl border border-orange-100">
            ...
            <div className="space-y-4">
              <div className="space-y-2 border-b border-orange-100 pb-3">
                <input
                  type="text"
                  name="package1Title"
                  value={formData.package1Title}
                  onChange={handleChange}
                  placeholder="Package 1 Title"
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 outline-none transition-all text-xs font-bold bg-white"
                />
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 outline-none transition-all text-sm"
                  />
                </div>
              </div>
          ...
          <div className="md:col-span-1 bg-blue-50/50 p-5 rounded-xl border border-blue-100">
            ...
            <div className="space-y-4">
              <div className="space-y-2 border-b border-blue-100 pb-3">
                <span className="block text-xs font-bold text-gray-700 bg-white/50 px-2 py-1 rounded">Package 1 (Matches Title)</span>
                <div className="flex items-center gap-2">
                  <span className="text-xs text-gray-500 w-12">Price:</span>
                  <input
                    type="number"
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none transition-all text-sm"
                  />
                </div>
              </div>
              <div className="space-y-2 border-b border-blue-100 pb-3">
                <span className="block text-xs font-bold text-gray-700 bg-white/50 px-2 py-1 rounded">Package 2 (Matches Title)</span>
                <div className="flex items-center gap-2">
                  <span className="text-xs text-gray-500 w-12">Price:</span>
                  <input
                    type="number"
              ...
              <div className="space-y-2">
                <span className="block text-xs font-bold text-gray-700 bg-white/50 px-2 py-1 rounded">Package 3 (Matches Title)</span>
                <div className="flex items-center gap-2">
                  <span className="text-xs text-gray-500 w-12">Price:</span>
                  <input
                    type="number"
