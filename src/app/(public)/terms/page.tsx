...
export const metadata = {
  title: 'Terms & Conditions - Mere Pandit Ji',
  description: 'Terms and conditions for using the Mere Pandit Ji platform.',
};
    ...
    <div className="bg-white min-h-screen py-16">
      <div className="container mx-auto px-6 md:px-12 lg:px-24 max-w-5xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <p>
            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.merepanditji.org ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
          </p>

          <p>
            The Platform is owned by Mere Pandit Ji, a company incorporated under the Companies Act, 1956 with its registered office at sco-35, 2nd Floor, Bala Ji complex, Dhakoli (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
          </p>
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">The use of Platform and/or availing of our Services is subject to the following Terms of Use:</h3>
